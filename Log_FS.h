...
*			Буква "я" соответсвует коду 0xFF, поэтому при записи "я" в память, конец файла может быть опреден неверно.
...
/***************************************************************************************************
	   ...
	   Возвращает:
					Порядковый последнего созданного файла
...
/***************************************************************************************************
	  ...
	  Примечания:
				...
				с помощью Log_Fs_GetFileProperties. Как только желанный файл был найден
